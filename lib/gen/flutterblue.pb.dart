...
class BluetoothCharacteristicIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BluetoothCharacteristicIdentifier', createEmptyInstance: create)
    ..aOS(1, 'uuid')
    ..a<$core.int>(2, 'instanceId', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  BluetoothCharacteristicIdentifier._() : super();
  factory BluetoothCharacteristicIdentifier() => create();
  factory BluetoothCharacteristicIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BluetoothCharacteristicIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  BluetoothCharacteristicIdentifier clone() => BluetoothCharacteristicIdentifier()..mergeFromMessage(this);
  BluetoothCharacteristicIdentifier copyWith(void Function(BluetoothCharacteristicIdentifier) updates) => super.copyWith((message) => updates(message as BluetoothCharacteristicIdentifier));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BluetoothCharacteristicIdentifier create() => BluetoothCharacteristicIdentifier._();
  BluetoothCharacteristicIdentifier createEmptyInstance() => create();
  static $pb.PbList<BluetoothCharacteristicIdentifier> createRepeated() => $pb.PbList<BluetoothCharacteristicIdentifier>();
  @$core.pragma('dart2js:noInline')
  static BluetoothCharacteristicIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BluetoothCharacteristicIdentifier>(create);
...
class BluetoothCharacteristic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BluetoothCharacteristic', createEmptyInstance: create)
    ..aOM<BluetoothCharacteristicIdentifier>(1, 'identifier', subBuilder: BluetoothCharacteristicIdentifier.create)
    ..aOS(2, 'remoteId')
  ...
  @$pb.TagNumber(1)
  set identifier(BluetoothCharacteristicIdentifier v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdentifier() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdentifier() => clearField(1);
  @$pb.TagNumber(1)
  BluetoothCharacteristicIdentifier ensureIdentifier() => $_ensure(0);
...
class BluetoothDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BluetoothDescriptor', createEmptyInstance: create)
    ...
    ..aOS(2, 'remoteId')
    ..aOS(3, 'serviceUuid', protoName: 'serviceUuid')
    ..aOM<BluetoothCharacteristicIdentifier>(4, 'characteristicId', subBuilder: BluetoothCharacteristicIdentifier.create)
  ...
  @$pb.TagNumber(4)
  set characteristicId(BluetoothCharacteristicIdentifier v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCharacteristicId() => $_has(3);
  @$pb.TagNumber(4)
  void clearCharacteristicId() => clearField(4);
  @$pb.TagNumber(4)
  BluetoothCharacteristicIdentifier ensureCharacteristicId() => $_ensure(3);
...
class ReadCharacteristicRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadCharacteristicRequest', createEmptyInstance: create)
    ..aOS(1, 'remoteId')
    ..aOM<BluetoothCharacteristicIdentifier>(2, 'characteristicId', subBuilder: BluetoothCharacteristicIdentifier.create)
    ..aOS(3, 'serviceUuid')
  ...
  @$pb.TagNumber(2)
  set characteristicId(BluetoothCharacteristicIdentifier v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCharacteristicId() => $_has(1);
  @$pb.TagNumber(2)
  void clearCharacteristicId() => clearField(2);
  @$pb.TagNumber(2)
  BluetoothCharacteristicIdentifier ensureCharacteristicId() => $_ensure(1);
...
class ReadDescriptorRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ReadDescriptorRequest', createEmptyInstance: create)
    ...
    ..aOS(3, 'serviceUuid')
    ..aOS(4, 'secondaryServiceUuid')
    ..aOM<BluetoothCharacteristicIdentifier>(5, 'characteristicId', subBuilder: BluetoothCharacteristicIdentifier.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set characteristicId(BluetoothCharacteristicIdentifier v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCharacteristicId() => $_has(4);
  @$pb.TagNumber(5)
  void clearCharacteristicId() => clearField(5);
  @$pb.TagNumber(5)
  BluetoothCharacteristicIdentifier ensureCharacteristicId() => $_ensure(4);
}
